<template>
    ...
    <form @submit.prevent="handleAddBook">
      <div class="p-3 p-lg-5 border">
        <div class="form-group row">
          <div class="col-md-12">
            <label for="bookName" class="text-black"
        ...
        <div class="form-group row">
          <div class="col-md-12">
            ...
            <input
              ...
              id="author"
              name="author"
              v-model="addBookPayload.authorName"
            />
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <div class="col-md-12">
            <label for="bookDescription" class="text-black"
  ...
  <div
    v-if="added === true"
    class="text-success text-center mt-3 font-weight-bold"
  >
    Book Added successfully
  </div>
  <div v-if="error" class="text-danger text-center mt-3 font-weight-bold">
    {{ error }}
  </div>
</template>
