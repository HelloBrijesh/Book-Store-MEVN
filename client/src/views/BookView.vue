...
<template>
  <div class="container mx-auto py-24">
    <div class="mx-auto flex flex-wrap items-start">
      ...
      <div class="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
        <h1 class="mb-4 text-3xl font-semibold text-black">Nike Air Max 21A</h1>
        <h2 class="my-4 text-xl font-semibold text-black">Author</h2>
  ...
  <div class="container mx-auto pb-32">
    ...
    <div class="flex justify-between gap-2">
      <div class="rounded-md border basis-1/3">
        <img
        ...
        <div class="p-4">
          ...
          <p class="mt-3 text-sm text-gray-600">Author</p>
          <button
            type="button"
      ...
      <div class="rounded-mdborder basis-1/3">
        <img
          src="https://images.unsplash.com/photo-1522199755839-a2bacb67c546?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGJsb2d8ZW58MHx8MHx8&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=60"
          alt="Laptop"
          class="h-[300px] w-full rounded-t-md object-cover"
